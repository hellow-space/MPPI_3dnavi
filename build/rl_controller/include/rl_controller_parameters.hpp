#pragma message("#include \"rl_controller_parameters.hpp\" is deprecated. Use #include <rl_controller/rl_controller_parameters.hpp> instead.")
...
[[nodiscard]] auto to_parameter_value(rsl::StaticVector<T, capacity> const& value) {
  ...
  public:
    ...
    : ParamListener(parameters_interface, rclcpp::get_logger("rl_controller"), prefix) {
